const NewsPanel = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#1e1e2d] rounded-lg border border-gray-200 dark:border-gray-800 p-4 transition-colors duration-200 flex-1 flex flex-col min-h-0">
      <h2 className="font-semibold text-base mb-4 flex-shrink-0 flex items-center justify-between text-gray-900 dark:text-gray-100">
        Market News
      ...
      <button className="text-sm flex-shrink-0 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#2a2a3b] mt-4 px-2 py-1 rounded font-semibold w-full text-left transition-colors flex items-center">
